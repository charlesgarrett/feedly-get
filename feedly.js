function FeedlyAPI(authCode, feedlyServer, client_id, client_secret, feedly_redirect, csrf_state) {
	"use strict";
    ...
    if (false === (this instanceof FeedlyAPI)) {
        ...
        return new FeedlyAPI(authCode, feedlyServer, client_id, client_secret, feedly_redirect, csrf_state);
    }
